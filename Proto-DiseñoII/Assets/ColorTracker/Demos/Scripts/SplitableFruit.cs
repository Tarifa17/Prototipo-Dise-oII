...
namespace Vexpot.ColorTrackerDemo
{
    ...
    public class SplitableFruit : MonoBehaviour, IPointerEnterHandler
    {
        ...
        /// </summary>
        public PhysicsMaterial physicMat;
        /// <summary>
        ...
        void SplitFruit()
        {
            if (canSplit)
            {
                ...
                if (_slice1)
                {
                    ...
                    _slice1.AddComponent<Rigidbody>().linearVelocity = transform.TransformDirection(new Vector3(5, 0, 0));
                ...
                if (_slice2)
                {
                    ...
                    _slice2.AddComponent<Rigidbody>().linearVelocity = transform.TransformDirection(new Vector3(-5, 0, 0)); ;
